...
class ViewTercero(models.Model):
    ...
    ciudad_id = models.IntegerField(db_column='ciudad_id')
    ciudad = models.CharField(db_column='ciudad', max_length=255)
    tipo_identificacion_id = models.IntegerField(db_column='tipo_identificacion_id')
    tipo_identificacion = models.CharField(db_column='tipo_identificacion', max_length=255)
    identificacion = models.CharField(db_column='identificacion', max_length=255)
